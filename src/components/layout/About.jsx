            ...
            <div className="flex flex-col justify-around flex-wrap items-center max-w-[900px] w-full px-5">
                ...
                >
                    ...
                    <p className="text-gray-300 text-lg sm:text-xl leading-relaxed max-w-3xl mx-auto">
                        I am a Software Engineer with expertise in web development, working with technologies such as React, Next.js, Node.js, and MongoDB.
                        I have experience in ASP.NET, Python, and Machine Learning. I aim to blend technical skills with business acumen to create impactful digital solutions.
                    </p>
                </motion.div>
